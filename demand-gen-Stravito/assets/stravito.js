...
(function () {
  ...
  const stages = [
    {
      color: "#780080", badge: "TOFU · Awareness", title: "Create demand",
    ...
    {
      color: "#b52d78", badge: "RMK · Authority", title: "Build trust",
    ...
    {
      color: "#de2864", badge: "MOFU · Interest", title: "Capture interest",
    ...
    {
      color: "#f04682", badge: "BOFU · Decision", title: "Convert",
  ...
  function comboChart(id, bars, line, barColor, opts) {
    ...
    const dots = pts.map((p, i) => {
      const c = el("circle", { cx: p[0], cy: p[1], r: 4.5, fill: "#de2864", stroke: "#fff", "stroke-width": 2, opacity: 0 });
      svg.appendChild(c);
      const lab = el("text", { class: "barval", x: p[0], y: p[1] - 12, "text-anchor": "middle", fill: "#de2864", opacity: 0 });
  ...
  const players = {
    chartReach: comboChart("chartReach", [16176, 57990, 203380], [0.12, 0.07, 0.02], "#780080", { barFmt: kfmt, lineFmt: gbp2 }),
    chartSessions: comboChart("chartSessions", [718, 1761, 2499], [2.8, 2.4, 1.8], "#780080", { barFmt: (v) => v.toLocaleString(), lineFmt: gbp1 }),
    chartCpl: barChart("chartCpl", [1006, 287, 207], "#de2864", gbp0),
    chartSql: barChart("chartSql", [1006, 473, 226], "#780080", gbp0),
  };
