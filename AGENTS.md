...
- The Career Hub is a Next.js programmatic-SEO site (~6,000 pages) built on an open-source CMS, documented as a portfolio case study (work/career-hub-organic.html) with Google Search Console performance data.
